  ...
  List<Album> loadAlbums() {
    List<Album> albumList = [
      ...
      Album()
        ...
        ..albumName = '爱，不解释'
        ..artistNames = ['张杰']
        ..albumImageUrl = 'http://p2.music.126.net/mW53BkMgGy37I7yVrUg-aQ==/109951163117902077.jpg?param=400y400'
        ..size = 9
      ...
      Album()
        ...
        ..albumImageUrl = 'http://p1.music.126.net/_LZPAOkbMdb0CDL2ra0RGw==/3305131953311675.jpg?param=400y400',
      Album()
        ..wyyId = '6548'
        ..albumName = '黑白灰'
        ..artistNames = ['陈奕迅']
        ..albumImageUrl = 'http://p2.music.126.net/WF9SAVpoTbueroj7CLoKKg==/109951163028210664.jpg?param=400y400'
        ..size = 10
        ..company = '英皇唱片',
    ];
    return albumList;
